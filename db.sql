...
-- Dumping data for table insta_style_lms.post_views: ~181 rows (approximately)
...
INSERT INTO `posts` (`id`, `category_id`, `role_id`, `title`, `content`, `hashtags`, `thumbnail_type`, `likes_count`, `comments_count`, `views_count`, `shares_count`, `quiz_active`, `my_course`, `status`, `created_at`, `updated_at`) VALUES
	...
	(2, 3, 1, 'JK Tyre Dealer Onboarding Process', 'JK Tyre Dealer Onboarding Process', '#JK Tyre #Dealer Onboarding Process', 'landscape', 2, 3, 4, 2, 1, 0, 'active', '2026-04-09 05:18:48', '2026-07-06 12:01:34'),
...
-- Dumping data for table insta_style_lms.user_video_analysis: ~3 rows (approximately)
INSERT INTO `user_video_analysis` (`id`, `user_id`, `assessment_id`, `question_id`, `video_file_path`, `audio_file_path`, `isAwsReportGenerated`, `aws_file_path`, `isGeminiReportGenerated`, `GeminiReportFilePath`, `uploaded_at`) VALUES
	(1, 1, 1, 1, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_1/QuestionID_1/video_1784099232455.mp4', 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_1/QuestionID_1/audio_1784099235260.wav', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_1/QuestionID_1/result_1784099259819.json', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_1/QuestionID_1/gemini_report_1784101014710.json', '2026-07-15 07:07:12'),
	(3, 4, 1, 1, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_4/QuestionID_1/video_1784615326800.mp4', 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_4/QuestionID_1/audio_1784615448057.wav', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_4/QuestionID_1/result_1784615472210.json', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_4/QuestionID_1/gemini_report_1784615480429.json', '2026-07-21 06:28:47'),
	(4, 3, 1, 1, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_3/QuestionID_1/video_1784615825116.mp4', 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_3/QuestionID_1/audio_1784615920133.wav', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_3/QuestionID_1/result_1784615938509.json', 2, 'uploads/AssessmentUserVideo/AssessmentID_1/UserID_3/QuestionID_1/gemini_report_1784615946524.json', '2026-07-21 06:37:05');
...
INSERT INTO `users` (`id`, `email`, `employee_id`, `name`, `phone`, `gender`, `password`, `role_id`, `dealer_id`, `city_id`, `profile_url`, `fcm_token`, `device_type`, `status`, `created_at`, `updated_at`) VALUES
	...
	(2, 'demo@sls2.com', 'EMP002', 'Neeraj Jain', '8989898989', 'male', '$2b$12$QBXiSY0OPhBa9qV8f48MzuRvUwqsl67/Sb1mjCjKsvlcszd5nvAQa', 1, 1, 1, '/uploads/users/2/profile-1775713867244.jpg', 'fcm_token_xyz_123_abc', 'android', 'active', '2026-04-09 05:51:07', '2026-07-08 09:21:12'),
...
INSERT INTO `video_analysis_overall_summary` (`id`, `userId`, `assessmentId`, `overall_face`, `overall_voice`, `overall_emotion`, `createdAt`, `updatedAt`) VALUES
	...
	(3, 3, 1, 82.73, 82.56, 48.22, '2026-07-21 12:08:58', NULL);
...
INSERT INTO `video_analysis_question_answer_evaluation` (`id`, `user_video_analysis_id`, `user_id`, `question_id`, `transcript`, `score`, `score_percentage`, `grammar_mistakes`, `sentiment`, `emotion`, `correctness`, `understanding`, `depth_and_clarity`, `explanation`, `matched_keywords`, `missing_keywords`, `created_at`, `updated_at`) VALUES
	...
	(3, 4, 3, 1, 'four value interiors ride mode support urban rain slipper clutch dual channel abs smart connect bluetooth oil oil system race tuned suspension aggressive styling value of money brand reliability', 48, 69, 3, 'neutral', 'informative', 'mostly correct', 'The user correctly identified the majority of the bike\'s technical features but lacked specific performance metrics and contained minor terminology errors (e.g., \'four value\' instead of \'4-valve\').', 'The answer is presented as a list of features rather than a cohesive explanation. While it hits most technical highlights, it lacks context regarding the engine output and competitor comparison.', 'You successfully identified most of the key selling points, such as the ride modes, safety features (ABS), and technology (SmartXonnect). However, you missed including the specific power figures (20.5 bhp/17 Nm) and made some transcription errors. Structuring your answer in complete sentences would improve clarity.', '["ride modes","slipper clutch","dual-channel ABS","SmartXonnect","oil-cooled","race-tuned suspension","aggressive styling","value for money"]', '["4-valve","20.5 bhp"]', '2026-07-21 12:09:06', '2026-07-21 12:09:06');
...
INSERT INTO `video_analysis_question_summary` (`id`, `userId`, `assessmentId`, `questionId`, `face_interest`, `face_concentration`, `face_doubt`, `face_anxiety`, `face_confidence`, `face_attention`, `voice_interest`, `voice_concentration`, `voice_doubt`, `voice_anxiety`, `voice_confidence`, `voice_attention`, `emotion_joy`, `emotion_sadness`, `emotion_fear`, `emotion_confusion`, `emotion_happy`, `emotion_neutral`, `createdAt`, `updatedAt`) VALUES
	...
	(3, 3, 1, 1, 70.88, 11.85, 1.32, 15.95, 82.73, 11.85, 71.30, 11.26, 1.40, 16.04, 82.56, 11.26, 0.01, 48.21, 2.86, 48.92, 0.01, 48.22, '2026-07-21 12:08:58', NULL);
